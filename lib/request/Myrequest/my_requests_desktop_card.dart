                    ...
                    PopupMenuItem(
                      ...
                      child: Row(
                        children: [
                          ...
                          SizedBox(width: 8),
                          Text("View Details", style: TextStyle(color: MyRequestsColors.textPrimary)),
                        ],
                      ),
                    ),
                    PopupMenuItem(
                      ...
                      child: Row(
                        children: [
                          ...
                          SizedBox(width: 8),
                          Text("Edit Request", style: TextStyle(color: MyRequestsColors.textPrimary)),
                        ],
                      ),
                    ),
                    PopupMenuItem(
                      ...
                      child: Row(
                        children: [
                          ...
                          SizedBox(width: 8),
                          Text("Delete", style: TextStyle(color: MyRequestsColors.accentRed)),
                        ],
                      ),
                    ),
                  ],
