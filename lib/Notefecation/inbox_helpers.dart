// // Notefecation/inbox_helpers.dart
...
//     if (selectedStatus != "All") {
//       filtered = filtered.where((request) {
//         final userForwardStatus = request["yourCurrentStatus"]?.toString();
//         final fulfilled = request["fulfilled"] == true;
//
//         switch (selectedStatus) {
//           case "Approved":
...
//             if (userForwardStatus == null) return true;
...
//   }
//
//   // 🔹 دالة لتحويل حالة forward إلى نص مقروء
...
//       case 'needs_change': return "Needs Change";
