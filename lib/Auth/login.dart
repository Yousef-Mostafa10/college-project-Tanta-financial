...
//
//   // 🔹 جلب بيانات المستخدم
//   Future<Map<String, dynamic>> _fetchUserData(String token, String username) async {
//     try {
...
//                 elevation: 5,
//                 child: Padding(
//                   padding: EdgeInsets.all(max(20, screenWidth * 0.04)),
...
//         children: [
//           Text(
//             "Tanta Finance System",
//             style: TextStyle(
//               fontSize: min(screenWidth * 0.06, 28),
...
//                   color: primaryLight, strokeWidth: 3)
//                   : const Text(
//                 "Sign In",
//                 style: TextStyle(
//                   color: Colors.white,
